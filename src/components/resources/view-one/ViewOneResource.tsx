...
import { ViewOneResourceContainer, SocialIcons, Thumbnail, ChipSelected, Section, Div } from './ViewOneResource.css';
...
import { exampleResourceFullInfo, exampleReviews, GenerateResourceReviews } from '../resource-interfaces';

/**
 * A resource will be rated by logged-in? users so the rating can be set here
 * 
 * @returns 
 */
const ViewOneResource: FC = () => {
    ...
    return <ViewOneResourceContainer>
        ...
        {/** Assuming resource hours will be pulled from Google Maps API? Added dummy data just in case */}
        <Section>
            <Div>
            MAP
            <br />
        ...
        <Section>
            {GenerateResourceReviews(reviews)}
        </Section>
    </ViewOneResourceContainer>
}

export default ViewOneResource;